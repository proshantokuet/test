...
<c:url var="cancelUrl" value="/project-group/list.html" />
...
<div class="page-content-wrapper">
    <div class="page-content">
        <ul class="page-breadcrumb breadcrumb">
            <li>
                <i class="fa fa-star" id="size_star" aria-hidden="true"></i> <span class="sub-menu-title"><strong>Project Group list</strong> </span>  <a  href="<c:url value="/"/>">Home</a>

            </li>
            <li>
                /  Project Group / Project Group list / Add new project group /
            </li>
            <li>
        ...
        <div class="portlet box blue-madison">
            ...
            <div class="portlet-body">
                ...
                <form:form modelAttribute="projectGroup" id="projectGroupInfo" class="form-inline" autocomplete="off">
...
<script>
    ...
    $("#projectGroupInfo").submit(function (event) {
        $("#loading").show();
        var url = "/opensrp-dashboard/rest/api/v1/project/group/save";
        ...
        $.ajax({
            ...
            success : function(data) {
                if (data == "") {
                    $('#loading').hide();
                    window.location.replace("/opensrp-dashboard/project-group/list.html");
                } else {
